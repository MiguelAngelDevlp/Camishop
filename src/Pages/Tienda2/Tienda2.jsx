...
const Tienda2 = () => {
    ...
    useEffect(() => {
        axios
            .get(apiURL)
            .then((response) => {
                const cafeSort = response.data.teams.slice(50,100)
...
<Link to={`/Tienda`}><button  className="margen" class="cta">
    <span class="hover-underline-animation">Página anterior</span>
</button></Link>
            <Link to={`/Tienda3`}><button class="cta">
    <span class="hover-underline-animation">Siguiente página</span>
